    ...
    INSERT INTO `selectt`.`Field` (`idField`, `category`, `atribute`, `weight`, `html_id`, `html_name`, `html_row_count`, `html_label`, `html_placeholder`, `html_info`) VALUES ('23', 'Testing tool support', 'Tool name', '0.00', 'toolName', 'toolName', '1', 'Tool name', 'Please enter with Tool name', 'Name of the tool if the technique presents one');
    INSERT INTO `selectt`.`Field` (`idField`, `category`, `atribute`, `weight`, `html_id`, `html_name`, `html_row_count`, `html_label`, `html_placeholder`, `html_info`) VALUES ('24', 'Testing tool support', 'Cost', '0.0670', 'cost', 'cost', '1', 'Cost', 'Please enter with Cost', 'The cost associated with the tool');
...
INSERT INTO `selectt`.`Technique` (`id`, `title`, `year`, `bibTex`, `link`, `needApproval`, `insertedBy`, `insertedOn`) VALUES (  1 , 'A Modular Approach to Model-based Testing of Concurrent Programs', 2013  , '"@Inbook{1,
    ...
    INSERT INTO `selectt`.  `ProgramRepresentation` (`idTechnique`,   `programRepresentation` ) VALUES (  125 ,'Buchi automaton');
